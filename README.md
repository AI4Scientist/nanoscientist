...
| Topic | Report |
|---|---|
| GitHub issue taxonomy for the Lean 4 theorem prover: clustering, labeling, and trend analysis across open and closed issues. | [report.pdf](showcases/lean4/report.pdf) |
